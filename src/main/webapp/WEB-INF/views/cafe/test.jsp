...
<body>
<%String d1 = "2021-04-20T14:05";
String d2 = "2021-04-21T14:05";
d1 = d1.replace("T", "\n");
%>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody><tr>
                                    <td class="content-block">
                                        <h2><%String ID = request.getParameter("ID"); out.print(ID); %>님의 예약 영수증</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                            ...
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        <tbody><tr>
                                                            <td>Service 1</td>
                                                            <td class="alignright"><%out.print(d1); %></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Service 2</td>
                                ...
                                <tr>
									...
									<img src="/cogather/img/cafe/kakaopaybtn.png">
									</div>
                                    </td>
                                </tr>
                                <tr>
