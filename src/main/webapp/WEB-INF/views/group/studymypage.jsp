...
<header class="header-area">
    ...
    <div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(/templates/groupMypageAsset/img/bg-img/b2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
            ...
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(/templates/groupMypageAsset/img/bg-img/b1.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="slide-content text-center">
            ...
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(/templates/groupMypageAsset/img/bg-img/b3.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="slide-content text-center">
