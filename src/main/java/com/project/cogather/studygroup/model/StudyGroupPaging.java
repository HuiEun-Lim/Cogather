...
public class StudyGroupPaging {
	...
	public StudyGroupPaging(int total, int nowPage, int cntPerPage) {
		setNowPage(nowPage);
	...
	public void pageInfo(Integer nowPage,Integer cntPerPage,Integer total) {
