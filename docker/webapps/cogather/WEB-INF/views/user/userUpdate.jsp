...
<h5>전화번호</h5>
<input type="text" name="phone" value=${dto.phone } ></input><br><br>
<h5>e-mail</h5>
<input type="text" name="email" value=${dto.email } ></input><br><br>
<h5>관심태그</h5>
<input type="text" name="tag" value=${dto.tag } ></input><br><br>
<br>
