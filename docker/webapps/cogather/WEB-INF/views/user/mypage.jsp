...
<div class="w3-top">
  ...
  <div class="choice">
    ...
    <sec:authorize access="isAuthenticated()">
    	...
    	<a href="${pageContext.request.contextPath}/mypage?id=${user_id }" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-red w3-border-bottom w3-border-amber">마이페이지</a>
